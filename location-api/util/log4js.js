...
log4js.configure({
    appenders: {
        out: { type: 'console' }, 
        default: { type: 'dateFile', filename: logPath+'default', pattern:"dd.log" }, 
        info: { type: 'dateFile', filename: logPath+'location-api-info',pattern:"dd.log"}, 
        debug: { type: 'dateFile', filename: logPath+'location-api-debug',pattern:"dd.log"}, 
        error: { type: 'dateFile', filename: logPath+'locatoin-api-error', pattern:"dd.log"}, 
    },
    categories: {
...
exports.debugLogger = (data)=>{
    ...
    this.consoleLogger('logPath'+logPath);
}
